...
@Repository
@Transactional
public interface InternalPageIdNavigationDao extends JpaRepository<InternalPageIdNavigationDao, Long> {
...
/*
    ...
    private String getAliasUrl(Collection<Alias> aliases) throws NodeLoadException, ModuleException {
        if (aliases == null || aliases.isEmpty()) {
            ...
            if (node == null) {
                throw new NodeLoadException(identifier, "The node with id='"+rootNode.key()+"' is not associated with an instance of type '"+rootNode.nodeType()+"'");
            }
